/**
 * Login — single purpose: sign in.
 * Premium layout: title, subtitle, form with focus/error states, primary CTA, secondary links.
 */
...
export function LoginScreen({ navigation }: Props) {
  ...
  }, [email, password, hideLoader, navigation, showLoader, toast]);
    ...
    >
      ...
      >
        ...
        <View style={styles.footer}>
          ...
          >
            <Text style={styles.linkPrimary}>{t('auth.register.title')}</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </KeyboardAvoidingView>
