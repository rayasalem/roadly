...
export function PaymentScreen() {
  ...
  const isEnabled = isMvpFeatureEnabled('payments');
    ...
    return (
      <SafeAreaView style={[styles.root, { backgroundColor: colors.background }]} edges={['top', 'bottom']}>
        ...
        <ScrollView style={styles.scroll} contentContainerStyle={styles.comingSoonContent} showsVerticalScrollIndicator>
          <MvpFeatureComingSoon
            iconName="credit-card-outline"
            previewIconName="credit-card-plus-outline"
            testID="payment-coming-soon"
          />
        </ScrollView>
      </SafeAreaView>
    );
    ...
    <SafeAreaView style={[styles.root, { backgroundColor: colors.background }]} edges={['top', 'bottom']}>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.content} showsVerticalScrollIndicator>
        <TouchableOpacity
          ...
          onPress={() => toast({ type: 'info', message: t('customer.addPaymentComingSoon') })}
          activeOpacity={0.85}
        >
