...
export const STRINGS: Record<Locale, Record<StringKey, string>> = {
  en: {
    ...
    'home.title': 'Home',
    'home.welcome': 'Home',
    'error.network': 'Network error. Check your connection and ensure the backend is running on port 4000.',
  ...
  ar: {
    ...
    'error.network': 'خطأ في الشبكة. تحقق من اتصالك وتأكد أن الخادم (Backend) يعمل على المنفذ 4000.',
